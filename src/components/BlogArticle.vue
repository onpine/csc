    ...
    <div id="left_content">
      <div id="the_author">
        <div class="head_name">
          ...
          <div class="nickname">
            <a id="aname" :href="href+'/Author/'+author.uid">{{author.username}}</a>
    ...
    <div class="article">
      <div id="article_title">
        ...
        <div id="otherwise">
          ...
          <span id="thubm" @click="thumbs">点赞:{{ thubms}}</span>
          <span class="visi">阅读量:{{visit}}</span>
          <span id="col" @click="blobcollection">收藏:{{collection}}</span>
          <b @click="changego('/LoggingStatus/BlogEditor/'+$route.params.webid)" id="change">修改</b>
        </div>
      </div>
      <mavon-editor
        class="md"
      ...
      />
      <div class="comment">
        <input type="text" name id="Statement" v-model="Statement" placeholder="发表评论" />
      ...
      Axios.post(
        ...
        .then((Response) => {
          ...
          switch (Response.data.json.code) {
            ...
            default:
              console.log("关注..." + Response.data.json.exception);
      ...
      Axios.post(
        ...
        .then((Response) => {
          ...
          switch (Response.data.json.code) {
            case 200:
              ++that.thubms;
              alert("点赞..." + Response.data.json.msg);
              break;

            default:
              console.log("点赞..." + Response.data.json.exception);
              alert("点赞..." + Response.data.json.exception);
              break;
          }
        })
        .catch((error) => {
      ...
      Axios.post(
        ...
        .then((Response) => {
          ...
          switch (Response.data.json.code) {
            case 200:
              ++that.collection;
              alert("收藏..." + Response.data.json.msg);
              break;

            default:
              console.log("收藏..." + Response.data.json.exception);
              alert("收藏..." + Response.data.json.exception);
              break;
          }
        })
        .catch((error) => {
    ...
    comment() {
      ...
      Axios.post(
        ...
        .then((Response) => {
          // console.log(Response.data.json);
          if (Response.data.json.code == 200) {
            alert("评论..." + Response.data.json.msg);
            that.commentList.reverse();
